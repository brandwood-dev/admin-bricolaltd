  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-admin-border">
        <h2 className="text-2xl font-bold text-primary animate-fade-in">Administration Bricola LTD</h2>
      </div>

      {/* Navigation */}
      <nav className="flex-1 p-4 space-y-6 animate-fade-in overflow-y-auto"
